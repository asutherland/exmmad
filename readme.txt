...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\exmmad on
     Windows, /home/user/dev/exmmad on Linux) in a file named
     exmmad@mozillamessaging.com and copy that file to
